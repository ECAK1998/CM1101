...
item_key_G = class_item("key", "Green")
item_key_B = class_item("key", "Blue")
item_key_I = class_item("key", "Indigo")
item_key_V = class_item("key", "Violet")
item_key_ROYGBIV = class_item("key", "rainbow")
